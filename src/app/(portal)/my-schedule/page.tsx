    ...
    <PageShell title="My Schedule" description="Your tasks and assignments for today.">
      <Card>
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h3 className="text-[16px] font-semibold text-neutral-900">Staff Schedule</h3>
          <p className="mt-2 max-w-md text-[14px] leading-relaxed text-neutral-500">
            View and manage your daily tasks, shift assignments, and team schedules all in one
            place.
          </p>
