...
export default function InspectionDetailPage() {
  ...
  useEffect(() => {
    async function fetchInspection() {
      try {
        setLoading(true);
        const res = await apiRequest(`/api/v1/inspections/${id}`, { method: 'GET' });
        if (res.status === 404) {
          setNotFound(true);
          return;
        }
  ...
  if (notFound) {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-20 text-center">
        ...
        <h1 className="text-[24px] font-bold text-neutral-900">Inspection not found</h1>
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-20 text-center">
        ...
        <h1 className="text-[24px] font-bold text-neutral-900">Error loading inspection</h1>
