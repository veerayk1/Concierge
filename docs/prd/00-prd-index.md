...
This PRD is organized into **29 files** (numbered 00 through 28). Each module document follows a standard template with **11 sections**:
...
| 21  | `21-demo-environment.md`      | Demo Environment       | Sales demo + training sandbox system                                  | Business   |
| 22  | `22-marketing-website.md`     | Marketing Website      | Customer-facing website, login routing, vanity URLs                   | Business   |
| 23  | `23-onboarding-wizard.md`     | Onboarding Wizard      | 8-step guided property setup                                          | Business   |
| 24  | `24-billing-subscription.md`  | Billing & Subscription | Stripe integration, tiers, invoicing, dunning                         | Business   |
| 25  | `25-help-center.md`           | Help Center            | In-app help, knowledge base, support tickets                          | Business   |
| 26  | `26-developer-portal-api.md`  | Developer Portal & API | REST API, webhooks, API keys, SDKs                                    | Business   |
| 27  | `27-data-migration.md`        | Data Migration         | Import/export, CSV mapping, DSAR, competitor migration                | Business   |
| 28  | `28-compliance-reports.md`    | Compliance Reports     | 8 compliance reports, monitoring, audit automation                    | Business   |
...
_This is a living document. Update the index table whenever a new PRD file is added or restructured._
